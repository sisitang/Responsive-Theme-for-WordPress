                ...
                <div class="content-area-section">
                    ...
                    <?php while( $reports->have_posts() ): $reports->the_post(); ?>
                        <div class="report-body">    
                            ...
                            ?>
                            <h2><?php echo get_field( 'report_name', $report_obj )?></h2>
                            <a href="<?php echo get_field( 'file', $report_obj )['url']?>"><img src="<?php echo get_field( 'thumbnail', $report_obj )['url']?>" alt=""></a>
                        </div>
